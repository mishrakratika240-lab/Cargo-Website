...
<body class="text-muted">
    ...
    <div class="back">
        ...
        <div  class=" ">
            <center>
                 <!-- style="border-style:#ffffff63;width: 500px;margin-left: 400px;background:#ffffff08;box-shadow: 0 25px 25px rgba(1,4,1,1.3);"> -->
                        ...
                        ?>
                                ...
                                <center>
                                   <br> <label for="full_name" >  </label>
                                    <input type="text" name="full_name" value="full_name" placeholder="Full Name" required ></input>
                                    <label for="email" >  </label>
                                    <input type="email" name="email" value="email" placeholder="email" required ></input></br>
                                    <br><label for="phone_number" >  </label>
                                    <input type="text" name="phone_number" value="phone_number" placeholder="Phone number" required ></input>
                                     <label  for="adhar_number">  </label>
                                    <input type="text" name="adhar_number"  value="adhar_number" placeholder="Adhar number" required ></input></br>
                                    ...
                                    <input  type="date" name="booking_date" value="booking_date" placeholder="mm/dd/yyyy"  required style="width: 35%;
                             /*margin-right: 40% ;*/ margin-left:1px !important;" ></input>
                                     <!-- <label for="Pickup_time" >  </label> -->
                                    <input type="time" name="booking_time" value="booking_time" placeholder="Pickup time" required style="width:37%;
                                        margin-right: 2px;margin-left: 3px ;" ></input><br>
                                    

                                    <br>
                                    <label for="pickup_location" >  </label>
                                    <input type="text" name="pickup_location" value="pickup_location"  placeholder="Pickup_location"  required ></input>
                                     <label >  </label>
                                    <input type="text" name="drop_off_location" value="drop_off_location" placeholder="Drop_off_location" required ></input>
                                    <br>
                                    <!-- <div style="margin-left: 12px;margin-right: 21px;width: 100% !important;"> -->
                                       <br>
                                       
                                    <label  for="material_weight"></label>
                                    <input type="text" name="material_weight" placeholder=" material weight" style="width:75%;padding: 2px;"><br>
                                    <br>
                                    <label  for="material_unit"></label>
                                    <input type="text" name="material_unit" value="material_unit" placeholder=" material unit" style="width:75%;padding: 2px;"><br>
                                    <br>
                                    ...
                                    <input type="submit" name="submit"onclick="openPopup()" value="submit" style="margin-left:25%;padding-right: 4px;background: aliceblue;">   
